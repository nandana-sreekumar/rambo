from tkinter import *
from submit import bot_name, getResponse, askQuestion
...
class ChatApplication:
    def __init__(self):
        ...
        self.q_index = 0
        self.play_music_state = False
        self._insert_qstn(askQuestion(self.q_index))
    ...
    def _setup_main_window(self):
        ...
        self.window.configure(width = 850,height = 650,bg = BG_COLOR)
    ...
    def _insert_msg(self,msg,sender=bot_name):
        if not msg:
            return
        print(msg)
    ...
    def _insert_qstn(self,qstn):
        if not qstn:
            return
        
        self.msg_entry.delete(0,END)
        msg1 = f"{bot_name}: {qstn}\n\n"
        self.text_widget.configure(state = NORMAL)
